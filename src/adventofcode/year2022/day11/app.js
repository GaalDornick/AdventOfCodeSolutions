...
class Monkey {
    constructor(_items, _operation, _nextMonkey) {
        this.throws = 0;
...
let puzzles = [
    [
        new Monkey([79, 98], old => old.mult(19), n => (n.remainder(23) == 0) ? 2 : 3),
        new Monkey([54, 65, 75, 74], old => old.add(6), n => (n.remainder(19) == 0) ? 2 : 0),
        new Monkey([79, 60, 97], old => old.square(), n => (n.remainder(13) == 0) ? 1 : 3),
        new Monkey([74], old => old.add(3), n => (n.remainder(17) == 0) ? 0 : 1),
    ],
    [
        new Monkey([83, 97, 95, 67], old => old.mult(19), n => (n.remainder(17) == 0) ? 2 : 7),
        new Monkey([71, 70, 79, 88, 56, 70], old => old.add(2), n => (n.remainder(19) == 0) ? 7 : 0),
        new Monkey([98, 51, 51, 63, 80, 85, 84, 95], old => old.add(7), n => (n.remainder(7) == 0) ? 4 : 3),
        new Monkey([77, 90, 82, 80, 79], old => old.add(1), n => (n.remainder(11) == 0) ? 6 : 4),
        new Monkey([68], old => old.mult(5), n => (n.remainder(13) == 0) ? 6 : 5),
        new Monkey([60, 94], old => old.add(5), n => (n.remainder(3) == 0) ? 1 : 0),
        new Monkey([81, 51, 85], old => old.square(), n => (n.remainder(5) == 0) ? 5 : 1),
        new Monkey([98, 81, 63, 65, 84, 71, 84], old => old.add(3), n => (n.remainder(2) == 0) ? 2 : 3),
    ]
];
{
